...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The last person gets dequeue first, but it was not a problem with the dequeue 
    // rather a problem with the enqueue since it added the next person at the beginning instead than at the end
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The code does not handle the Forever scenario when Turns equal Zero
    ...
    // Defect(s) Found:  The code does not handle the Forever scenario when Turns equal Negative
