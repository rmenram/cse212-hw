public class SimpleQueue
{
    ...
    {
        // _queue.Insert(0, value); //Bug 1: the enqueue should add values at the end of the queue, not at the beginning
        _queue.Add(value);
    }
    ...
    private int Dequeue()
    {
        ...
        // var value = _queue[1]; //Bug 2: dequeue should get the first value which is indicated by Index Zero, not Index One
        // _queue.RemoveAt(1);  // (same Bug 2 for this line of code)
        var value = _queue[0];
        _queue.RemoveAt(0);
        return value;
    }
